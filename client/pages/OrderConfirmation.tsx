              ...
              <div className="bg-gray-50 rounded-xl p-6 mb-8 text-left">
                ...
                <div className="space-y-4">
                  <div className="flex items-center justify-between">
                    ...
                    <span className="font-medium text-gray-900">{latestOrder.id}</span>
                  </div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <span className="text-gray-600 block text-sm">Delivery Address:</span>
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <span className="text-gray-600 block text-sm">Estimated Delivery:</span>
                      <span className="font-medium text-gray-900">
            ...
            <div className="bg-blue-50 rounded-xl p-6 mb-8">
              ...
              <div className="text-left space-y-2 text-blue-800">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-sm">Suppliers will prepare your items</span>
                </div>
                <div className="flex items-center gap-2">
                  <div className="w-2 h-2 bg-blue-500 rounded-full"></div>
                  <span className="text-sm">You'll receive delivery updates via SMS</span>
                </div>
                <div className="flex items-center gap-2">
                  <div className="w-2 h-2 bg-blue-500 rounded-full"></div>
                  <span className="text-sm">Items will be delivered to your address</span>
                </div>
              </div>
            </div>
